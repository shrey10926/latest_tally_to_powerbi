...
"""
    ...
    def combined_data_to_csv(final_data):
        ...
        sales_df = deduplicated_data[deduplicated_data['V_TYPE'] == 'Sales'].reset_index(drop = True)
        purchase_df = deduplicated_data[deduplicated_data['V_TYPE'] == 'Purchase'].reset_index(drop = True)
        ...
        out.to_excel(os.path.join('csv_files', 'final_dataframe.xlsx'), index=None)